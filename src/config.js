 ...
 * ⚠️ ЧОРНОВИЙ ТЕКСТ — замініть на фінальний опис проєкту від замовника.
 *    Композицію (поля, кегль, інтерліньяж) задано у scenes.jsx / IntroText.
 */
window.INTRO = {
  kicker: 'про проєкт',
  lines: [
    '«Українці» — це фотопроєкт про людей,',
    'їхні щоденні історії та красу, що народжується',
    'у зміні пір року. Протягом чотирьох сезонів ми',
    'збирали моменти, у яких проступає характер,',
    'тепло і сила нашого народу.',
  ],
};
